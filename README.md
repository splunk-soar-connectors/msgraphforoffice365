...
[list rules](#action-list-folders) - Get all the messageRule objects defined for the user's inbox   
...
[get rule](#action-get-email) - Get the properties and relationships of a messageRule object   
